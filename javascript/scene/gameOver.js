...
export default class GameOver extends Phaser.Scene {
  ...
  create() {
    ...
    distanceText = this.add.text(0, 0, `Distance: ${Math.floor(playerInfo.distanceTraveled)}`, { font:'40px Georgia', fontFamily: 'Georgia, "Goudy Bookletter 1911", Times, serif' }).setOrigin(0.5, 0.5).setDepth(3);
